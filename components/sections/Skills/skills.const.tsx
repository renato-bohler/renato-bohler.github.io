const skills: Skill[] = [
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="152.441 275.281 446.124 321.514">
          <defs>
            <path
              id={this.id}
  ...
  },
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="2.929 -2.196 124.777 133.564">
          <defs>
            <path
              id={this.id}
  ...
  },
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="0 50 1024 1024">
          <defs>
            <path
              id={this.id}
  ...
  },
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="-4.38 -5.338 107.676 107.949">
          <defs>
            <path
              id={`${this.id}-1`}
  ...
  },
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="0 0 551.226 533.485">
          <defs>
            <path
              id={this.id}
              d="M 237.513 278.843 L 313.713 278.843 L 275.613 187.243 L 237.513 278.843 Z M 275.613 42.743 L 67.813 117.143 L 99.613 392.843 L 275.613 490.743 L 451.613 392.843 L 483.413 117.143 L 275.613 42.743 Z M 405.813 384.543 L 357.213 384.543 L 331.013 319.143 L 220.413 319.143 L 194.213 384.543 L 145.513 384.543 L 275.613 92.243 L 405.813 384.543 Z"
            />
          </defs>
          <use
            xlinkHref={`#${this.id}`}
  ...
  },
  {
    ...
    icon: function (isContrastMode: boolean): React.ReactElement {
      ...
      return (
        <svg aria-hidden viewBox="0 0 339 362">
          <defs>
            <path
              id={this.id}
			...
			s128,24.853,128,42.667C373.333,81.813,324.629,106.667,245.333,106.667z"
              transform="matrix(1, 0, 0, 1, -76.58812, 40)"
            />
          </defs>
          <use
            xlinkHref={`#${this.id}`}
